...
#define UX_PICTBRIDGE_DPSHOST_NO
...
#define UX_PICTBRIDGE_MAX_FILE_NAME_SIZE                    64 
...
#define UX_PICTBRIDGE_XML_LEAF                              ((void*) 0xFFFFFFFF)
...
#define UX_PICTBRIDGE_EVENT_FLAG_FUNCTION_NOT_SUPPORT       0XFFFFFFFF
...
typedef struct UX_PICTBRIDGE_JOBINFO_STRUCT
{
    ...
    UINT                                                    (*ux_pictbridge_jobinfo_object_data_read)(struct UX_PICTBRIDGE_STRUCT *pictbridge, UCHAR *buffer,  ULONG offset, ULONG length, ULONG *actual_length);
...
UINT _ux_pictbridge_dpsclient_reset(UX_PICTBRIDGE *pictbridge);
...
UINT  _ux_pictbridge_tag_end_locate(UCHAR *input_buffer, ULONG input_length, 
                                  UCHAR **output_buffer, ULONG *output_length);
