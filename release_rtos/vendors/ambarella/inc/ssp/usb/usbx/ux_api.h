...
#define UX_HCD_EHSET_PID_TEST_FORCE_ENABLE                              0x0109

#define UX_HCD_EHSET_PID_TEST_SUSPEND_RESUME_STEP_2                     0x10000106
#define UX_HCD_EHSET_PID_TEST_SET_FEATURE_STEP_2                        0x10000108
...
typedef struct UX_TRANSFER_STRUCT
{
	...
	VOID            (*ux_application_hook_function)(ULONG, void*);
...
void uhc_resource_set_SimplePidVid(UINT32 pid, UINT32 vid);
UINT32 uhc_resource_get_SimplePid(void);
UINT32 uhc_resource_get_SimpleVid(void);
