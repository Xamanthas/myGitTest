...
#define UX_DEVICE_CLASS_PIMA_RC_GROUP_NOT_SUPPORTED                                 0xA805
...
#ifdef UX_PIMA_WITH_MTP_SUPPORT														
#define UX_DEVICE_CLASS_PIMA_DEV_PROP_USE_DEVICE_STAGE_FLAG                     0xD303
...
// Define PIMA Read Cache Buffer Index
// This is for MTP throughput improvement
#define UX_DEVICE_CLASS_PIMA_READ_CACHE_INDEX_0 0x01
#define UX_DEVICE_CLASS_PIMA_READ_CACHE_INDEX_1 0x10
...
typedef struct UDC_PIMA_BULK_SEND_INFO_STRUCT
{
	UCHAR *data;
	ULONG size;
	ULONG result;
...
typedef struct UX_SLAVE_CLASS_PIMA_STRUCT
{
    ...
    UINT                    (*ux_device_class_pima_object_thumb_get)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, ULONG object_handle, UCHAR *object_buffer, ULONG object_offset,
    ...
    UINT                    (*ux_device_class_pima_object_custom_command)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, ULONG parameter1, ULONG parameter2, ULONG parameter3, ULONG parameter4, ULONG parameter5, ULONG* Length, ULONG* dir);
    UINT                    (*ux_device_class_pima_object_custom_data_get)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, UCHAR *ObjectBuffer, ULONG ObjectOffset,ULONG ObjectLengthRequested, ULONG *ObjectActualLength);
    UINT                    (*ux_device_class_pima_object_custom_data_send)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, UCHAR *ObjectBuffer, ULONG ObjectOffset, ULONG ObjectLength);
    UINT                    (*ux_device_class_pima_object_vendor_process)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, struct UX_SLAVE_CLASS_PIMA_VENDOR_PROCESS_INFO_STRUCT *vendor_cmd_info);
    VOID                    *ux_device_class_pima_application;
    VOID                    (*ux_device_class_pima_transfer_canceled)(void);
...
typedef struct UX_SLAVE_CLASS_PIMA_PARAMETER_STRUCT
{
    ...
    UINT                    (*ux_device_class_pima_parameter_object_data_get)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, ULONG object_handle, UCHAR *object_buffer, ULONG object_offset,
                                                                ULONG object_length_requested, ULONG *object_actual_length, USHORT opcode);
    UINT                    (*ux_device_class_pima_parameter_object_thumb_get)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, ULONG object_handle, UCHAR *object_buffer, ULONG object_offset,
                                                                    ULONG object_length_requested, ULONG *object_actual_length);
    ...
    UINT                    (*ux_device_class_pima_parameter_custom_command)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, ULONG parameter1, ULONG parameter2, ULONG parameter3, ULONG parameter4, ULONG parameter5, ULONG* Length, ULONG* dir);
    UINT                    (*ux_device_class_pima_parameter_custom_data_get)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, UCHAR *ObjectBuffer, ULONG ObjectOffset,ULONG ObjectLengthRequested, ULONG *ObjectActualLength);
    UINT                    (*ux_device_class_pima_parameter_custom_data_send)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, UCHAR *ObjectBuffer, ULONG ObjectOffset, ULONG ObjectLength);
    UINT                    (*ux_device_class_pima_parameter_vendor_handler)(struct UX_SLAVE_CLASS_PIMA_STRUCT *pima, struct UX_SLAVE_CLASS_PIMA_VENDOR_PROCESS_INFO_STRUCT *vendor_cmd_info);
    VOID                    *ux_device_class_pima_parameter_application;
    VOID                    (*ux_device_class_pima_parameter_transfer_canceled)(void);
