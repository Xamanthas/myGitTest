...
UINT    _ux_device_stack_class_register(UCHAR *class_name,
                                        ...
                                        VOID *parameter);
UINT    _ux_device_stack_class_clear(void);
...
UINT    _ux_device_stack_free(VOID);
...
typedef UINT32 (*udc_clear_stall_callback)(UINT32 logical_endpoint_id);
typedef UINT32 (*udc_set_interface_callback)(UINT32 intface_number, UINT32 alternate_setting);
UINT    udc_register_clear_stall_callback(udc_clear_stall_callback cb);
UINT    udc_register_set_interface_callback(udc_set_interface_callback cb);
UINT    udc_set_endpoint_transfer_timeout(UINT value);
UINT    udc_get_endpoint_transfer_timeout(void);
UINT    udc_set_endpoint_bulk_in_timeout(UINT value);
UINT    udc_get_endpoint_bulk_in_timeout(void);
UINT    udc_set_endpoint_in_max_data_length(UINT32 value);
UINT    udc_get_endpoint_in_max_data_length(void);
UINT    udc_set_endpoint_out_max_data_length(UINT32 value);
UINT    udc_get_endpoint_out_max_data_length(void);
#endif
