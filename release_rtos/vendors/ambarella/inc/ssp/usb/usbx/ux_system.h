...
extern UCHAR _ux_system_class_video_vc_input_terminal_descriptor_structure[];
extern UCHAR _ux_system_class_video_vc_processing_unit_descriptor_structure[];
extern UCHAR _ux_system_class_video_vc_encoding_unit_descriptor_structure[];
extern UCHAR _ux_system_class_video_vc_output_terminal_descriptor_structure[];
extern UCHAR _ux_system_class_video_vc_extension_unit_descriptor_structure[];
extern UCHAR _ux_system_class_video_streaming_interface_descriptor_structure[];
extern UCHAR _ux_system_class_video_vs_input_header_descriptor_structure[];
extern UCHAR _ux_system_class_video_vs_mjeg_format_descriptor_structure[];
extern UCHAR _ux_system_class_video_vs_uncompressed_format_descriptor_structure[];
extern UCHAR _ux_system_class_video_vs_h264_format_descriptor_structure[];
extern UCHAR _ux_system_class_video_vs_frame_descriptor_structure[];
extern UCHAR _ux_system_class_video_vs_h264_frame_descriptor_structure[];
...
extern UCHAR _ux_system_slave_class_simple_name[];
extern UCHAR _ux_system_slave_class_uvc_name[];
