...
/*                                                                        */
/*  07-04-2012     William E. Lamie         Initial Cortex-A9/IAR         */
/*                                            Support Version 5.0         */
...
#define TX_THREAD_USER_EXTENSION    UINT UserValue;
#endif
...
#if __CPU_MODE__ == 2 && !defined __GNUC__
...
CHAR                            _tx_version_id[] =
                                    "Copyright (c) 1996-2014 Express Logic Inc. * ThreadX Cortex-A9/IAR Version G5.6.5.1 SN: 3675-264-0901 *";
#else
