...
/*                                            added timeout sequence      */ 
/*                                            information to the thread   */ 
/*                                            control block, resulting in */ 
/*                                            version 5.6.2               */ 
/*                                                                        */ 
/**************************************************************************/ 
...
typedef struct TX_TIMER_INTERNAL_STRUCT
{
    ...
    ULONG               tx_timer_internal_smp_core_control;
...
typedef struct TX_THREAD_STRUCT
{
    ...
    ULONG               tx_thread_timeout_sequence;     
    ULONG               tx_thread_suspend_sequence;     
...
UINT        _tx_thread_smp_core_exclude(struct TX_THREAD_STRUCT *thread_ptr, ULONG exclusion_map);
UINT        _tx_thread_smp_core_exclude_get(struct TX_THREAD_STRUCT *thread_ptr, ULONG *exclusion_map_ptr);
UINT        _tx_thread_smp_core_get(void);
UINT        _tx_timer_smp_core_exclude(struct TX_TIMER_STRUCT *timer_ptr, ULONG exclusion_map);
UINT        _tx_timer_smp_core_exclude_get(struct TX_TIMER_STRUCT *timer_ptr, ULONG *exclusion_map_ptr);
...
/* The tx_time_get API is previously mapped to simply pickup the global counter.  */
